...
// If filter types are not selected we show ascending order id
if (!$filter_col) {
...
$db = getDbInstance();
$select = array('id', 'FullName', 'Team', 'EmployeeID','EMail', 'MobileNo','DOB');
...
if ($search_string) 
{
    ...
    $db->orwhere('EmployeeID', '%' . $search_string . '%', 'like');
}
...
$employees = $db->arraybuilder()->paginate("employees", $page, $select);
    ...
    <div class="row">
        ...
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_employee.php?operation=create">
        ...
        <tbody>
            <?php foreach ($employees as $row) : ?>
                <tr>
	                ...
	                <td>
					<a href="edit_employee.php?employee_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="employees.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
